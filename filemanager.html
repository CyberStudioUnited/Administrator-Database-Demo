...
//Application Title
define('APP_TITLE', '127.0.0.1 File Manager');
...
$auth_users = array(
    'admin' => '$2y$10$PMSvecCq6EKZUvPc2XYVjeX/upt8tHPwhasSXxEFN.qVtBdCDXwce', //admin@123
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Admin Database 1994-2021</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> AdminDV File Manager <?php echo VERSION; ?></a></h3></p>
